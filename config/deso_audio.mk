#
# Desolation Audio Files
#

ALARM_PATH := vendor/deso/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/deso/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/deso/prebuilt/common/media/audio/ringtones
